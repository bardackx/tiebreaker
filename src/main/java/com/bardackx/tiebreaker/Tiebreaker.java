...
public class Tiebreaker<E> {
  ...
  public Tiebreaker<E> earliest(Function<E, Object> mapper) {
    return lowest(mapper);
  }

  public Tiebreaker<E> latest(Function<E, Object> mapper) {
    return highest(mapper);
  }

  public Tiebreaker<E> ascending(Function<E, Object> mapper) {
    return lowest(mapper);
  }

  public Tiebreaker<E> descending(Function<E, Object> mapper) {
    return highest(mapper);
  }
